<%-- 
    Document   : cart
    Created on : 20 ene. 2023, 13:38:40
    Author     : caelo
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page session="false" %>
<%@page import="java.util.List, com.mycompany.multishop.model.entity.User, com.mycompany.multishop.model.entity.Category, com.mycompany.multishop.model.entity.Product, com.mycompany.multishop.model.entity.Cart" %>
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">${cart[status.index].quantity}</td>
                            <td class="align-middle">${cart[status.index].quantity * product.price}</td>
                            <td class="align-middle">
                                <form action="DeleteProductFromCartServlet" method="POST">
                                    <input type="hidden" name="idCart" value="${cart[status.index].idCart}"/>
                                    <button type="submit" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button>
                                </form>
                            </td>
                        </tr>
                        <c:set var="totalPrice" value="${totalPrice + cart[status.index].quantity * product.price }"></c:set>
                        </c:forEach>
                    </tbody>
                </table>
            </div>
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pb-2">
                        <div class="d-flex justify-content-between mb-3">
                            <h6>Sub-Total</h6>
                            <h6>$<c:out value="${totalPrice}"></c:out></h6>
                        </div>
                    ...
                    <div class="pt-2">
                        <div class="d-flex justify-content-between mt-2">
                            <h5>Total</h5>
                            <h5>$<c:out value="${totalPrice + 100}"></c:out></h5>
                        </div>
                        <button id="submitChecklist" class="btn btn-block btn-primary font-weight-bold my-3 py-3">Enviar Solicitud</button>
                    </div>
                </div>
            </div>
        </div>
