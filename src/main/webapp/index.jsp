<%-- 
    Document   : index
    Created on : 15 ene. 2023, 20:39:44
    Author     : caelo
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page session="false" %>
<%@page import="java.util.List, com.mycompany.multishop.model.entity.User, com.mycompany.multishop.model.entity.Category" %>
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            ...
                            <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                                ...
                                if(request.getSession(false) != null){
                                %>
                                <a href="DisplayCartServlet" class="btn px-0 ml-3">
            ...
            <div class="row px-xl-5 pb-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                        ...
                        <h5 class="font-weight-semi-bold m-0">Devoluciones en 14 Días</h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
        ...
        <div class="container-fluid pt-5">
            ...
            <div class="row px-xl-5 pb-3">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        ...
                        <a class="text-decoration-none" href="ShopServlet?idCategory=<%=category.getIdCategory()%>" >
                                <div class="cat-item d-flex align-items-center mb-4">
                                    <div class="overflow-hidden" style="width: 100px; height: 100px;">
                                        <img class="img-fluid" src="<%=category.getImgPath()%>" alt="">
                                    </div>
                                    
                                    <div class="flex-fill pl-3">
                                        <h6><%=category.getName()%></h6>
                                        <small class="text-body"><%=category.getQuantity()%> Productos</small>
                                    </div>
                                </div>
