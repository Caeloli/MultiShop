<%-- 
    Document   : store
    Created on : 20 ene. 2023, 03:48:18
    Author     : caelo
--%>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-1">
                                <div class="product-item bg-light mb-4">
                                    <div class="product-img position-relative overflow-hidden">
                                        <img class="img-fluid w-100" src="i<c:out value="${product.imgPath}"></c:out>" alt="">
                                        <div class="product-action">
                                            <form action="AddProductToCartServlet" method="POST">
                                                ...
                                                <input type="hidden" name="idProduct" value="<c:out value="${product.idProduct}"></c:out>"/>
                                            </form>
                                    ...
                                    <div class="text-center py-4">
                                        <a class="h6 text-decoration-none text-truncate" href=""><c:out value="${product.name}"></c:out></a>
                                            <div class="d-flex align-items-center justify-content-center mt-2">
                                                <h5><c:out value="$ ${product.price}"></c:out></h5> <!-- <h6 class="text-muted ml-2"><del><c:out value="${product}"></c:out></del></h6> -->
                                            </div>
                                            <div class="d-flex align-items-center justify-content-center mb-1">

                                                    <small>Productos Restantes: <c:out value="${product.quantity}"></c:out></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
