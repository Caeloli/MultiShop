...
public class AddProductToCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        cartDto.getEntity().setIdProduct(idProduct);
        cartDto = cartDao.readFromIdProduct(cartDto);
        
        if(cartDto == null){ //Create new Product Inside Cart
            cartDto = new CartDTO();
            cartDto.getEntity().setIdProduct(idProduct);
            cartDto.getEntity().setIdUser(idUser);
            cartDto.getEntity().setQuantity(quantity);
            cartDao.create(cartDto);
        } else{ //Product Already Exists Inside Cart
            cartDto.getEntity().setQuantity(cartDto.getEntity().getQuantity() + quantity);
